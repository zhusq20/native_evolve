...
MODEL_PATH="./sft/output/memory_sft_qwen3_8b"
...
CAND_NUM=4
EXP_NAME="rl__qwen3_8b__cand${CAND_NUM}__maxstep_${MAX_STEPS}_rb${ROLLOUT_BATCH_SIZE}_rn${ROLLOUT_N}_gb${GLOBAL_BATCH_SIZE}"
