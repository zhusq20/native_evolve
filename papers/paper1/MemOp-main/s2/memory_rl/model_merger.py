...
if __name__ == "__main__":
    ...
    parser.add_argument("--local-dir", required=True, type=str, help="The path for your saved model")
    parser.add_argument("--hf-upload-path", default=False, type=str, help="The path of the huggingface repo to upload")
